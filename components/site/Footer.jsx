...
export const Footer = () => {
    return (<footer className="relative pt-20 pb-10 border-t border-border/50 mesh-bg">
      <div className="container">
        <div className="grid md:grid-cols-12 gap-10 mb-16">
          <div className="md:col-span-5">
            ...
            <div className="mt-6 flex items-center gap-3">
              {[Instagram, Linkedin, Twitter].map((Icon, i) => (<a key={i} href="#" className="inline-flex h-10 w-10 items-center justify-center rounded-full glass hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="Social link">
        ...
        <div className="relative mb-10 overflow-hidden">
          <div className="font-display font-semibold text-[20vw] leading-none text-gradient opacity-10 select-none pointer-events-none text-center">
            Localify
          </div>
        </div>
...
const FooterCol = ({ title, links }) => (<div className="md:col-span-2 lg:col-span-2 xl:col-span-2">
