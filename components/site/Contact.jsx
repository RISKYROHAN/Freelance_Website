...
export const Contact = () => {
    ...
    return (<section id="contact" className="relative py-24 lg:py-32 overflow-hidden">
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[800px] h-[600px] rounded-full bg-primary/10 blur-[140px] pointer-events-none"/>

      <div className="container relative">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          {/* Left */}
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <div className="text-xs uppercase tracking-[0.2em] text-accent font-medium mb-4">[ Contact ]</div>
            <h2 className="font-display text-4xl lg:text-5xl xl:text-6xl font-semibold leading-[1.05] tracking-tight">
              Ready to <span className="serif font-normal text-gradient-primary">scale</span> your business?
            </h2>
        ...
        ].map((item) => (<div key={item.label} className="flex items-center gap-4 group">
                  <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl glass group-hover:bg-gradient-primary transition-colors">
          ...
          <div className="lg:col-span-7">
            <form onSubmit={onSubmit} className="relative rounded-[2rem] glass-strong p-8 lg:p-10 space-y-6">
              ...
              <button type="submit" disabled={loading} className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 rounded-full bg-gradient-primary text-primary-foreground px-8 py-4 text-sm font-semibold shadow-glow hover:shadow-[0_0_80px_hsl(var(--primary)/0.5)] transition-all hover:scale-[1.02] disabled:opacity-60">
...
const Field = ({ label, children }) => (<label className="block">
