...
const works = [
    ...
    {
        img: "/assets/work-restaurant.jpg",
      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16 lg:mb-20">
          <div className="max-w-2xl">
            <div className="text-xs uppercase tracking-[0.2em] text-accent font-medium mb-4">[ Selected Works ]</div>
            <h2 className="font-display text-4xl lg:text-5xl xl:text-6xl font-semibold leading-[1.05] tracking-tight">
              Where strategy meets <span className="serif font-normal text-gradient-primary">premium UI.</span>
            </h2>
          </div>
